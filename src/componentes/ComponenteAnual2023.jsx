...
import recibDatosMes2023 from "../funciones/recibDatosMes2023";

function ComponenteAnual2023() {
  const [data, setData] = useState([]);
  useEffect(() => {
    recibDatosMes2023(setData);
  }, []);
...
export default ComponenteAnual2023;